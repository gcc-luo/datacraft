...
- [x] **Step 3: Add the module and minimal contracts**
...
- [x] **Step 1: Write failing crypto and domain tests**
...
- [x] **Step 3: Implement minimal AES-GCM and domain contracts**
...
- [x] **Step 2: Run the mapping test and confirm RED**
...
- [x] **Step 3: Implement migration and repository adapter**
...
- [x] **Step 4: Run mapping and existing backend tests**
...
- [x] **Step 1: Write failing URL/service tests**
...
- [x] **Step 2: Run MVC tests and confirm RED**
...
- [x] **Step 3: Implement controller, exception mapping, and environment docs**
...
- [x] **Step 4: Run MVC and full backend tests**
...
- [x] **Step 3: Implement the UI and API client**
...
- [x] **Step 1: Update progress only after tests are green**
...
- [x] **Step 3: Run real Docker smoke test**
...
- [x] **Step 4: Report verified completion and boundaries**
